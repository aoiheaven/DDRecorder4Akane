        ...
        try:
            if self.config.get('spec', {}).get('uploader', {}).get('clips', {}).get('upload_clips', False):
                ...
                for filename in filelists:
                    ...
                    _true_filelists.append(file_path)
                ...
                if _true_filelists:
                    ...
                    # Skip clips submission due to the lack of clips video in outputs/...
                    pass
